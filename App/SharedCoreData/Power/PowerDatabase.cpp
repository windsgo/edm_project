...
bool PowerDatabase::_create_table_with_default_params() {
    const char *create_table_cmd = R"(CREATE TABLE "eleparam" (
                                   ...
                                   "E_SV"	INTEGER NOT NULL DEFAULT 6 CHECK("E_SV" >= 0 AND "E_SV" < 256),
                                   ...
                                   "E_S"	INTEGER NOT NULL DEFAULT 2 CHECK("E_S" >= 0 AND "E_S" < 256),
                                   "E_PL"	INTEGER NOT NULL DEFAULT 0 CHECK("E_PL" >= 0 AND "E_PL" <= 1),
                                   "E_C"	INTEGER NOT NULL DEFAULT 0 CHECK("E_C" >= 0 AND "E_C" < 256),
                                   "E_LV"	INTEGER NOT NULL DEFAULT 1 CHECK("E_LV" >= 0 AND "E_LV" <= 2),
                                   "E_JS"	INTEGER NOT NULL DEFAULT 14435 CHECK("E_JS" >= 0 AND "E_JS" < 99999),
